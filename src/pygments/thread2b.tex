\begin{Verbatim}[label=\makebox{\url{https://github.com/lucabaldini/cmepda/tree/master/slides/latex/snippets/threading_lock.py}},commandchars=\\\{\}]
...
\PY{k}{def} \PY{n+nf}{thread\_task}\PY{p}{(}\PY{n}{lock}\PY{p}{)}\PY{p}{:}
...
\PY{k}{def} \PY{n+nf}{main\_task}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{x} \PY{o}{=} \PY{l+m+mi}{0}
    \PY{c+c1}{\# Creating a lock}
    \PY{n}{lock} \PY{o}{=} \PY{n}{threading}\PY{o}{.}\PY{n}{Lock}\PY{p}{(}\PY{p}{)}

    \PY{c+c1}{\# Creating threads}
    \PY{n}{t1} \PY{o}{=} \PY{n}{threading}\PY{o}{.}\PY{n}{Thread}\PY{p}{(}\PY{n}{target}\PY{o}{=}\PY{n}{thread\_task}\PY{p}{,} \PY{n}{args}\PY{o}{=}\PY{p}{(}\PY{n}{lock}\PY{p}{,}\PY{p}{)}\PY{p}{)}
    \PY{n}{t2} \PY{o}{=} \PY{n}{threading}\PY{o}{.}\PY{n}{Thread}\PY{p}{(}\PY{n}{target}\PY{o}{=}\PY{n}{thread\_task}\PY{p}{,} \PY{n}{args}\PY{o}{=}\PY{p}{(}\PY{n}{lock}\PY{p}{,}\PY{p}{)}\PY{p}{)}
