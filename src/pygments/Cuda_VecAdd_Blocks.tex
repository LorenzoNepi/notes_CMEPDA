\begin{Verbatim}[label=\makebox{\url{https://github.com/lucabaldini/cmepda/tree/master/slides/latex/snippets/cuda_vec_add_gpu.cu}},commandchars=\\\{\}]
...
\PY{+w}{  }\PY{n}{c}\PY{p}{[}\PY{n+nb}{blockIdx}\PY{p}{.}\PY{n}{x}\PY{p}{]}\PY{+w}{ }\PY{o}{=}\PY{+w}{ }\PY{n}{a}\PY{p}{[}\PY{n+nb}{blockIdx}\PY{p}{.}\PY{n}{x}\PY{p}{]}\PY{o}{+}\PY{n}{b}\PY{p}{[}\PY{n+nb}{blockIdx}\PY{p}{.}\PY{n}{x}\PY{p}{]}\PY{p}{;}
\PY{p}{\PYZcb{}}
...
\PY{+w}{  }\PY{n}{VecAddGpu}\PY{o}{\PYZlt{}}\PY{o}{\PYZlt{}}\PY{o}{\PYZlt{}}\PY{n}{N}\PY{p}{,}\PY{l+m+mi}{1}\PY{o}{\PYZgt{}}\PY{o}{\PYZgt{}}\PY{o}{\PYZgt{}}\PY{p}{(}\PY{n}{d\_a}\PY{p}{,}\PY{n}{d\_b}\PY{p}{,}\PY{n}{d\_c}\PY{p}{)}\PY{p}{;}
