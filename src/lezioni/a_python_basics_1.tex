...
\begin{figure}[H]
\centering\includegraphics[width=0.35\textwidth]{vcs_local}
\end{figure}
...
\begin{figure}[H]
\centering\includegraphics[width=0.35\textwidth]{vcs_centralized}
\end{figure}
...
\begin{figure}[H]
\centering\includegraphics[width=0.35\textwidth]{vcs_distributed}
\end{figure}
