\section{Advanced concepts for GANs and Gradient Reversal Layers}
...
GANs made incredible progress over the last decade, moving from generating blurry "dogs with three heads" in 2014 to photorealistic human faces and even playable video games from simple videos of people actually playing them like PacMan or Grand Theft Auto. However, their training dynamics are notoriously unstable. 
...
Simply removing a column from your dataset is rarely enough, because the nuisance information is usually highly correlated with other features the network can still exploit. Let's look at three practical examples:
\begin{enumerate}
...
\subsection{Practical implementation and hands-on examples}
